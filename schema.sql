...
-- 创建本地用户 example，密码为 password
-- 将 awesome 数据库下所有表的 select, insert, update, delete 权限授予该用户
grant select, insert, update, delete on awesome.* to 'example'@'localhost' identified by 'password';
